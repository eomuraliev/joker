...
describe('digest', function() {
  ...
  it('allows destroying a $watch with the watch removal function', function() {
    scope.aValue = 'abc';
    scope.counter = 0;
...
describe('$watchGroup', function() {
  ...
  it('does not call the zero-watch listener when deregistered first', function() { var counter = 0;
...
describe('inheritance', function() {
  it("inherits the parent scope's properties", function() {
  ...
  describe("$watchCollection", function() {
    ...
    it("notices when an attribute is removed from an object", function() {
      ...
      delete scope.obj.a; scope.$digest();
      expect(scope.counter).toBe(2);
